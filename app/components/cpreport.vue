<template>
  ...
  <div ref="pdfTemplate" class="hidden pa-2">
        ...
        <tbody>
          <tr>
            <td height="45px" class="text-center border border-black">
              {{
                cpItem?.levels[3]?.empapp == 0
                  ? "ยังไม่อนุมัติ"
                  : findUserName(cpItem?.levels[3]?.empapp)
              }}
            </td>
            <td height="45px" class="text-center border border-black">
              {{
                cpItem?.levels[2]?.empapp == 0
                  ? "ยังไม่อนุมัติ"
                  : findUserName(cpItem?.levels[2]?.empapp)
              }}
            </td>
            <td height="45px" class="text-center border border-black">
              {{
                cpItem?.levels[1]?.empapp == 0
                  ? "ยังไม่อนุมัติ"
                  : findUserName(cpItem?.levels[1]?.empapp)
              }}
            </td>
            <td height="45px" class="text-center border border-black">
              {{ findUserName(cpItem?.TEC_CPHREC_EMPNO) }}
            </td>
            <td height="45px" class="text-center border border-black">
              {{ findUserName(cpItem?.OPR_HREC_EMPNO) }}
            </td>
          </tr>
        </tbody>
      </table>
    ...
    <div
      class="pa-3 border border-black w-[800px] bg-white mt-3 mb-5 space-y-2"
    >
      <div class="grid grid-cols-3 gap-4">
        <div><strong>Line:</strong> {{ cpItem?.OPR_HREC_LINE }}</div>
        <div>
          <strong>Date:</strong> {{ dateFormat(cpItem?.OPR_HREC_DATEREC) }}
        </div>
        <div>
      ...
      <div class="grid grid-cols-1 gap-4">
        <div class="flex items-center gap-2">
          ...
          <input
            type="checkbox"
            class="w-4 h-4 mt-3"
            :checked="cpItem?.OPR_HREC_STATUSMDL === 'Urgent'"
          />
          <span>Urgent</span>
          <input
            type="checkbox"
            class="w-4 h-4 mt-3"
            :checked="cpItem?.OPR_HREC_STATUSMDL === 'Normal'"
          />
          <span>Normal</span>
          <input
            type="checkbox"
          ...
          <input
            type="checkbox"
            class="w-4 h-4 mt-3"
            :checked="cpItem?.OPR_HREC_STATUSMDL === 'New model'"
          />
          <span>New model</span>
          <input
            type="checkbox"
            class="w-4 h-4 mt-3"
            :checked="cpItem?.OPR_HREC_STATUSMDL === 'Over Plan'"
          />
          <span>Over Plan</span>
        </div>
      </div>
      <div class="grid grid-cols-2 gap-4">
        <div>
          <strong>Current Model Code:</strong> {{ cpItem?.OPR_HREC_CURMDLNM }}
        </div>
        <div>
      ...
      <div class="grid grid-cols-1 gap-4">
        <div class="flex items-center gap-2">
          ...
          <input
            type="checkbox"
            class="w-4 h-4 mt-3"
            :checked="cpItem?.OPR_HREC_CONTECN === 'No Have'"
          />
          <span>No Have</span>
          <input
            type="checkbox"
            class="w-4 h-4 mt-3"
            :checked="cpItem?.OPR_HREC_CONTECN === 'Have'"
          />
          <span>Have</span>
          ...
          <div class="ms-3">
            ...
            <span>{{
              cpItem?.OPR_HREC_CONTECN === "No Have"
                ? "ไม่มี"
                : cpItem?.OPR_HREC_HAVECONTECN_NO
            }}</span>
            <strong class="ms-3">ECN REV:</strong>
            <span>{{
              cpItem?.OPR_HREC_CONTECN === "No Have"
                ? "ไม่มี"
                : cpItem?.OPR_HREC_HAVECONTECN_REV
            }}</span>
          </div>
        </div>
      </div>
      ...
      <div class="flex flex-col">
        <div class="flex items-center gap-2">
          ...
          <input
            type="checkbox"
            class="w-4 h-4 mt-3"
            :checked="cpItem?.TEC_CPHREC_LOADINP === 'Use'"
          />
          <span>Use</span>
          <input
            type="checkbox"
            class="w-4 h-4 mt-3"
            :checked="cpItem?.TEC_CPHREC_LOADINP === 'Not Use'"
          />
          <span>Not Use</span>
        </div>
      </div>
      <div class="flex flex-col">
        <div class="flex items-center gap-2">
          ...
          <input
            type="checkbox"
            class="w-4 h-4 mt-3"
            :checked="cpItem?.TEC_CPHREC_LOADINPPITCH === '10 mm.'"
          />
          <span>10 mm.</span>
          <input
            type="checkbox"
            class="w-4 h-4 mt-3"
            :checked="cpItem?.TEC_CPHREC_LOADINPPITCH === '20 mm.'"
          />
          <span>20 mm.</span>
          <input
            type="checkbox"
            class="w-4 h-4 mt-3"
            :checked="cpItem?.TEC_CPHREC_LOADINPPITCH === '30 mm.'"
          />
          <span>30 mm.</span>
        </div>
      </div>
    ...
    >
      <div class="flex items-center gap-2">
        ...
        <input
          type="checkbox"
          class="w-4 h-4 mt-3"
          :checked="cpItem?.TEC_CPHREC_STACK === 'Use'"
        />
        <span>Use</span>
        <input
          type="checkbox"
          class="w-4 h-4 mt-3"
          :checked="cpItem?.TEC_CPHREC_STACK === 'Not Use'"
        />
        <span>Not Use</span>
      </div>
    </div>
    ...
    >
      <div class="flex items-center gap-2">
        ...
        <input
          type="checkbox"
          class="w-4 h-4 mt-3"
          :checked="cpItem?.TEC_CPHREC_TRACEINP === 'Use'"
        />
        <span>Use</span>
        <input
          type="checkbox"
          class="w-4 h-4 mt-3"
          :checked="cpItem?.TEC_CPHREC_TRACEINP === 'Not Use'"
        />
        <span>Not Use</span>
      </div>
    </div>
      ...
      <div class="flex flex-col">
        <div class="flex items-center gap-2">
          ...
          <input
            type="checkbox"
            class="w-4 h-4 mt-3"
            :checked="cpItem?.TEC_CPHREC_PCBCLEAN === 'Use'"
          />
          <span>Use</span>
          <input
            type="checkbox"
            class="w-4 h-4 mt-3"
            :checked="cpItem?.TEC_CPHREC_PCBCLEAN === 'Not Use'"
          />
          <span>Not Use</span>
        </div>
      </div>
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_GLUE === 'Use'"
            />
            <span>Use</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_GLUE === 'Not Use'"
            />
            <span>Not Use</span>
          </div>
        </div>
      ...
      <div class="grid grid-cols-2">
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <span>{{ cpItem?.TEC_CPHREC_GLUENUM }}</span>
          </div>
        </div>
      </div>
      <div class="grid grid-cols-2">
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_GLUESTDOK === 'OK'"
            />
            <span>Confirm OK</span>
          </div>
          <span>{{
            cpItem?.TEC_CPHREC_GLUESTDOK === null
              ? cpItem?.TEC_CPHREC_GLUESTDNOT
              : ""
          }}</span>
        </div>
      </div>
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_GLUESND === 'Use'"
            />
            <span>Use</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_GLUESND === 'Not Use'"
            />
            <span>Not Use</span>
          </div>
        </div>
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_GLUESNDOK === 'OK'"
            />
            <span>Confirm OK</span>
          </div>
          <span>{{
            cpItem?.TEC_CPHREC_GLUESNDOK === null
              ? cpItem?.TEC_CPHREC_GLUESNDNOT
              : ""
          }}</span>
        </div>
      </div>
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_MNTF === 'Use'"
            />
            <span>Use</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_MNTF === 'Not Use'"
            />
            <span>Not Use</span>
          </div>
        </div>
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_MNTFNOZ === 'Automatic'"
            />
            <span>Automatic</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_MNTFNNOZ === 'Manual'"
            />
            <span>Manual</span>
          </div>
        </div>
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_MNTFSUPT === 'Pin'"
            />
            <span>Pin</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_MNTFSUPT === 'Magnet'"
            />
            <span>Magnet</span>
            <input
              type="checkbox"
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_MNTSN === 'Use'"
            />
            <span>Use</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_MNTSN === 'Not Use'"
            />
            <span>Not Use</span>
          </div>
        </div>
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_MNTSNNOZ === 'Automatic'"
            />
            <span>Automatic</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_MNTSNNOZ === 'Manual'"
            />
            <span>Manual</span>
          </div>
        </div>
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_MNTSNSUPT === 'Pin'"
            />
            <span>Pin</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_MNTSNSUPT === 'Magnet'"
            />
            <span>Magnet</span>
            <input
              type="checkbox"
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_MNTTR === 'Use'"
            />
            <span>Use</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_MNTTR === 'Not Use'"
            />
            <span>Not Use</span>
          </div>
        </div>
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_MNTTRNOZ === 'Automatic'"
            />
            <span>Automatic</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_MNTTRNOZ === 'Manual'"
            />
            <span>Manual</span>
          </div>
        </div>
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_MNTTRSUPT === 'Pin'"
            />
            <span>Pin</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_MNTTRSUPT === 'Magnet'"
            />
            <span>Magnet</span>
            <input
              type="checkbox"
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_MNTFO === 'Use'"
            />
            <span>Use</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_MNTFO === 'Not Use'"
            />
            <span>Not Use</span>
          </div>
        </div>
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_MNTFONOZ === 'Automatic'"
            />
            <span>Automatic</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_MNTFONOZ === 'Manual'"
            />
            <span>Manual</span>
          </div>
        </div>
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_MNTFOSUPT === 'Pin'"
            />
            <span>Pin</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_MNTFOSUPT === 'Magnet'"
            />
            <span>Magnet</span>
            <input
              type="checkbox"
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_MNTINSP === 'Use'"
            />
            <span>Use</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_MNTINSP === 'Not Use'"
            />
            <span>Not Use</span>
          </div>
        </div>
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_REFLOW === 'Use'"
            />
            <span>Use</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_REFLOW === 'Not Use'"
            />
            <span>Not Use</span>
          </div>
        </div>
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_REFLOXYGEN === 'Use'"
            />
            <span>Use</span>
            <span>{{
              cpItem?.TEC_CPHREC_REFLOXYGEN === "Use"
                ? cpItem?.TEC_CPHREC_REFLOO
                : ""
            }}</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3 ms-3"
              :checked="cpItem?.TEC_CPHREC_REFLOXYGEN === 'Not Use'"
            />
            <span>Not Use</span>
          </div>
        </div>
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_REFLPCBSUPT === 'Use'"
            />
            <span>Use</span>
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3 ms-3"
              :checked="cpItem?.TEC_CPHREC_REFLPCBSUPT === 'Not Use'"
            />
            <span>Not Use</span>
          </div>
        </div>
            ...
            <tbody>
              <tr>
                ...
                <td class="p-2 break-words">
                  {{ cpItem?.TEC_CPHREC_TOP_TEMPCH1 }}
                </td>
                <td class="p-2 break-words">
                  {{ cpItem?.TEC_CPHREC_BTM_TEMPCH1 }}
                </td>
              </tr>
              <tr>
                <td class="p-2 break-words">CH-2</td>
                <td class="p-2 break-words">
                  {{ cpItem?.TEC_CPHREC_TOP_TEMPCH2 }}
                </td>
                <td class="p-2 break-words">
                  {{ cpItem?.TEC_CPHREC_BTM_TEMPCH2 }}
                </td>
              </tr>
              <tr>
                <td class="p-2 break-words">CH-3</td>
                <td class="p-2 break-words">
                  {{ cpItem?.TEC_CPHREC_TOP_TEMPCH3 }}
                </td>
                <td class="p-2 break-words">
                  {{ cpItem?.TEC_CPHREC_BTM_TEMPCH3 }}
                </td>
              </tr>
              <tr>
                <td class="p-2 break-words">CH-4</td>
                <td class="p-2 break-words">
                  {{ cpItem?.TEC_CPHREC_TOP_TEMPCH4 }}
                </td>
                <td class="p-2 break-words">
                  {{ cpItem?.TEC_CPHREC_BTM_TEMPCH4 }}
                </td>
              </tr>
              <tr>
                <td class="p-2 break-words">CH-5</td>
                <td class="p-2 break-words">
                  {{ cpItem?.TEC_CPHREC_TOP_TEMPCH5 }}
                </td>
                <td class="p-2 break-words">
                  {{ cpItem?.TEC_CPHREC_BTM_TEMPCH5 }}
                </td>
              </tr>
              <tr>
                <td class="p-2 break-words">CH-6</td>
                <td class="p-2 break-words">
                  {{ cpItem?.TEC_CPHREC_TOP_TEMPCH6 }}
                </td>
                <td class="p-2 break-words">
                  {{ cpItem?.TEC_CPHREC_BTM_TEMPCH6 }}
                </td>
              </tr>
              <tr>
                <td class="p-2 break-words">CH-7</td>
                <td class="p-2 break-words">
                  {{ cpItem?.TEC_CPHREC_TOP_TEMPCH7 }}
                </td>
                <td class="p-2 break-words">
                  {{ cpItem?.TEC_CPHREC_BTM_TEMPCH7 }}
                </td>
              </tr>
              <tr>
                <td class="p-2 break-words">CH-8</td>
                <td class="p-2 break-words">
                  {{ cpItem?.TEC_CPHREC_TOP_TEMPCH8 }}
                </td>
                <td class="p-2 break-words">
                  {{ cpItem?.TEC_CPHREC_BTM_TEMPCH8 }}
                </td>
              </tr>
              <tr>
                <td class="p-2 break-words">CH-9</td>
                <td class="p-2 break-words">
                  {{ cpItem?.TEC_CPHREC_TOP_TEMPCH9 }}
                </td>
                <td class="p-2 break-words">
                  {{ cpItem?.TEC_CPHREC_BTM_TEMPCH9 }}
                </td>
              </tr>
              <tr>
                <td class="p-2 break-words">CH-10</td>
                <td class="p-2 break-words">
                  {{ cpItem?.TEC_CPHREC_TOP_TEMPCH10 }}
                </td>
                <td class="p-2 break-words">
                  {{ cpItem?.TEC_CPHREC_BTM_TEMPCH10 }}
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_PCBCOOL === 'Use'"
            />
            <span>Use</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_PCBCOOL === 'Not Use'"
            />
            <span>Not Use</span>
          </div>
        </div>
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_AUTO === 'Use'"
            />
            <span>Use</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_AUTO === 'Not Use'"
            />
            <span>Not Use</span>
          </div>
        </div>
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_NGSTCK === 'Use'"
            />
            <span>Use</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_NGSTCK === 'Not Use'"
            />
            <span>Not Use</span>
          </div>
        </div>
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_NGSTCKPITCH === '10 mm.'"
            />
            <span>10 mm.</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_NGSTCKPITCH === '20 mm.'"
            />
            <span>20 mm.</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_NGSTCKPITCH === '30 mm.'"
            />
            <span>30 mm.</span>
          </div>
        </div>
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_TRACE === 'Use'"
            />
            <span>Use</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_TRACE === 'Not Use'"
            />
            <span>Not Use</span>
          </div>
        </div>
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_UNLOADER === 'Use'"
            />
            <span>Use</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_UNLOADER === 'Not Use'"
            />
            <span>Not Use</span>
          </div>
        </div>
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_UNLOADERPITCH === '10 mm.'"
            />
            <span>10 mm.</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_UNLOADERPITCH === '20 mm.'"
            />
            <span>20 mm.</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="cpItem?.TEC_CPHREC_UNLOADERPITCH === '30 mm.'"
            />
            <span>30 mm.</span>
          </div>
        </div>
...
// Watch เมื่อ props.cpItem เปลี่ยน -> สร้าง PDF ทันที
watch(
  () => props.cpItem,
  async (newVal) => {
    if (!newVal) return;
