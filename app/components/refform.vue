...
<h1 class="text-md">Clear Form</h1>
    ...
    <v-row no-gutters>
      ...
      <v-col cols="12" md="4" v-if="glue_ref_use">
        ...
        <v-text-field variant="outlined" density="compact" v-model="glue_prg" :value="props.prgnm" />
    ...
    <v-row no-gutters>
      ...
      <v-col cols="12" md="4" v-if="solder_user_std">
        ...
        <v-text-field variant="outlined" density="compact" v-model="solder_prgnm" :value="props.prgnm" class="w-auto" />
    ...
    <v-row no-gutters>
      ...
      <v-col cols="12" md="4" v-if="mounter_ref_use">
        ...
        <v-text-field variant="outlined" density="compact" v-model="prg_ref_mount1" :value="props.prgnm" />
    ...
    <v-row no-gutters>
      ...
      <v-col cols="12" md="4" v-if="mounter2_ref_use">
        ...
        <v-text-field variant="outlined" density="compact" v-model="prg_ref_mount2" :value="props.prgnm" />
    ...
    <v-row no-gutters>
      ...
      <v-col cols="12" md="4" v-if="mounter3_ref_use">
        ...
        <v-text-field variant="outlined" density="compact" v-model="prg_ref_mount3" :value="props.prgnm" />
    ...
    <v-row no-gutters>
      ...
      <v-col cols="12" md="4" v-if="mounter4_ref_use">
        ...
        <v-text-field variant="outlined" density="compact" v-model="prg_ref_mount4" :value="props.prgnm" />
    ...
    <v-row no-gutters>
      ...
      <v-col cols="12" md="4" v-if="mounter_ref_inps_std">
        ...
        <v-text-field variant="outlined" density="compact" v-model="prg_ref_inspct" :value="props.prgnm" />
      </v-col>
    </v-row>
    <v-row no-gutters>
      <v-col cols="6" md="4">
    ...
    <v-row no-gutters>
      ...
      <v-col cols="12" md="4" v-if="auto_rf_inps_std">
        <div class="mt-3 font-semibold">Program name</div>
        <v-text-field variant="outlined" density="compact" v-model="prg_rf_auto" :value="props.prgnm" />
      </v-col>
    </v-row>
    <v-row no-gutters>
      <v-col cols="6" md="4">
