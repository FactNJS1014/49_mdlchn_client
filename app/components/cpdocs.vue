  ...
  <div ref="pdfTemplate" class="hidden pa-2">
    ...
    <div class="grid grid-cols-2">
      ...
      <div class="flex flex-col">
        <div class="flex items-center gap-2">
          ...
          <input type="checkbox" class="w-4 h-4 mt-3" :checked="dataItem?.TEC_CPHREC_GLUEPROG === 'Referent Assembly chart part list for AM'
            " />
    ...
    <div class="grid grid-cols-2">
      ...
      <div class="flex flex-col">
        <div class="flex items-center gap-2">
          ...
          <input type="checkbox" class="w-4 h-4 mt-3" :checked="dataItem?.TEC_CPHREC_GLUENUM === 'Referent Assembly chart part list for AM'
            " />
          <span>Referent Assembly chart part list for AM</span>
        </div>
      </div>
    ...
    <div class="grid grid-cols-2">
      ...
      <div class="flex flex-col">
        <div class="flex items-center gap-2">
          <strong> Program name: </strong>
          <input type="checkbox" class="w-4 h-4 mt-3" :checked="dataItem?.TEC_CPHREC_GLUESNDPROG ===
    ...
    <div class="grid grid-cols-2">
      ...
      <div class="flex flex-col">
        <div class="flex items-center gap-2">
          <strong> Glue Number: </strong>
          <input type="checkbox" class="w-4 h-4 mt-3" :checked="dataItem?.TEC_CPHREC_GLUESNDNUM ===
            'Referent Assembly chart part list for AM'
            " />
          <span>Referent Assembly chart part list for AM</span>
        </div>
    ...
    <div class="grid grid-cols-2">
      ...
      <div class="flex flex-col">
        <div class="flex items-center gap-2">
          <strong> Program name: </strong>
          <input type="checkbox" class="w-4 h-4 mt-3" :checked="dataItem?.TEC_CPHREC_MNTFPROG === 'Referent Assembly chart part list for AM'
            " />
          <span>Referent Assembly chart part list for AM</span>
        </div>
      </div>
    ...
    <div class="grid grid-cols-2">
      ...
      <div class="flex flex-col">
        <div class="flex items-center gap-2">
          <strong> Program name: </strong>
          <input type="checkbox" class="w-4 h-4 mt-3" :checked="dataItem?.TEC_CPHREC_MNTSNPROG ===
            'Referent Assembly chart part list for AM'
            " />
          <span>Referent Assembly chart part list for AM</span>
        </div>
    ...
    <div class="grid grid-cols-2">
      ...
      <div class="flex flex-col">
        <div class="flex items-center gap-2">
          <strong> Program name: </strong>
          <input type="checkbox" class="w-4 h-4 mt-3" :checked="dataItem?.TEC_CPHREC_MNTTRPROG ===
            'Referent Assembly chart part list for AM'
            " />
          <span>Referent Assembly chart part list for AM</span>
        </div>
    ...
    <div class="grid grid-cols-2">
      ...
      <div class="flex flex-col">
        <div class="flex items-center gap-2">
          <strong> Program name: </strong>
          <input type="checkbox" class="w-4 h-4 mt-3" :checked="dataItem?.TEC_CPHREC_MNTFOPROG ===
            'Referent Assembly chart part list for AM'
            " />
          <span>Referent Assembly chart part list for AM</span>
        </div>
    ...
    <div class="grid grid-cols-2">
      ...
      <div class="flex flex-col">
        <div class="flex items-center gap-2">
          <strong> Program name: </strong>
          <input type="checkbox" class="w-4 h-4 mt-3" :checked="dataItem?.TEC_CPHREC_MNTINSPPROG ===
            'Referent Assembly chart part list for AM'
            " />
          <span>Referent Assembly chart part list for AM</span>
        </div>
    ...
    <div class="grid grid-cols-2">
      ...
      <div class="flex flex-col">
        <div class="flex items-center gap-2">
          <strong> Program name: </strong>
          <input type="checkbox" class="w-4 h-4 mt-3" :checked="dataItem?.TEC_CPHREC_REFLPROG === 'Referent Assembly chart part list for AM'
            " />
          <span>Referent Assembly chart part list for AM</span>
        </div>
      </div>
    ...
    <div class="grid grid-cols-2">
      ...
      <div class="flex flex-col">
        <div class="flex items-center gap-2">
          <strong> Program name: </strong>
          <input type="checkbox" class="w-4 h-4 mt-3" :checked="dataItem?.TEC_CPHREC_AUTOPROG === 'Referent Assembly chart part list for AM'
            " />
          <span>Referent Assembly chart part list for AM</span>
        </div>
      </div>
