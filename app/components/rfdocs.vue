        ...
        <div>
          ...
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.OPR_HREC_PROCS_RF === 'CP'"
            />
            <span>CP</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.OPR_HREC_PROCS_RF === 'RF1'"
            />
            <span>RF1</span>
            <input
              type="checkbox"
        ...
        <div>
          ...
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.OPR_HREC_PROCS_RF_CHN === 'CP'"
            />
            <span>CP</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.OPR_HREC_PROCS_RF_CHN === 'RF1'"
            />
            <span>RF1</span>
            <input
              type="checkbox"
      ...
      <div class="flex flex-col">
        <div class="flex items-center gap-2">
          ...
          <input
            type="checkbox"
            class="w-4 h-4 mt-3"
            :checked="dataItem?.TEC_RFHREC_LOADINP === 'Use'"
          />
          <span>Use</span>
          <input
            type="checkbox"
      ...
      <div class="flex flex-col">
        <div class="flex items-center gap-2">
          ...
          <input
            type="checkbox"
            class="w-4 h-4 mt-3"
            :checked="dataItem?.TEC_RFHREC_LOADINPPITCH === '10 mm.'"
          />
          <span>10 mm.</span>
          ...
          <input
            type="checkbox"
            class="w-4 h-4 mt-3"
            :checked="dataItem?.TEC_RFHREC_LOADINPPITCH === '20 mm.'"
          />
          <span>20 mm.</span>
    ...
    >
      <div class="flex items-center gap-2">
        ...
        <input
          type="checkbox"
          class="w-4 h-4 mt-3"
          :checked="dataItem?.TEC_RFHREC_STACK === 'Use'"
        />
        <span>Use</span>
        <input
          type="checkbox"
    ...
    >
      <div class="flex items-center gap-2">
        ...
        <input
          type="checkbox"
          class="w-4 h-4 mt-3"
          :checked="dataItem?.TEC_RFHREC_TRACEINP === 'Use'"
        />
        <span>Use</span>
        <input
          type="checkbox"
    ...
    >
      <div class="flex flex-col">
        <div class="flex items-center gap-2">
          ...
          <input
            type="checkbox"
            class="w-4 h-4 mt-3"
            :checked="dataItem?.TEC_RFHREC_PCBCLEAN === 'Use'"
          />
          <span>Use</span>
          <input
            type="checkbox"
      ...
      <div class="flex flex-col">
        <div class="flex items-center gap-2">
          ...
          <span>{{ dataItem?.TEC_RFHREC_PCBCLNFUNC }}</span>
          <strong>ETC: </strong>
          <span>{{ dataItem?.TEC_RFHREC_PCBLNETC }}</span>
        </div>
      </div>
    </div>
      ...
      <div class="grid grid-cols-2">
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_PRINT === 'Use'"
            />
            <span>Use</span>
            <input
              type="checkbox"
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <span>{{ dataItem?.TEC_RFHREC_PRINTPROG }}</span>
          </div>
        </div>
      </div>
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_PRINTSUPT === 'Backup plate'"
            />
      ...
      <div class="grid grid-cols-2">
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <span>{{ dataItem?.TEC_RFHREC_PRINTSOLDER }}</span>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="grid grid-cols-2">
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_GLUE === 'Use'"
            />
            <span>Use</span>
            <input
              type="checkbox"
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <span>{{ dataItem?.TEC_RFHREC_GLUEPROG }}</span>
          </div>
        </div>
      </div>
      <div class="grid grid-cols-2">
    ...
    <div class="border border-black px-3 py-4 avoid-break-inside">
      <div class="grid grid-cols-2">
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_SOLDERINSP === 'Use'"
            />
            <span>Use</span>
            <input
              type="checkbox"
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            <strong> Program name: </strong>
            <span>{{ dataItem?.TEC_RFHREC_SOLDERPROG }}</span>
          </div>
        </div>
      </div>
    </div>
    <div class="border border-black px-3 py-4 avoid-break-inside">
      <div class="grid grid-cols-2">
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_MNTF === 'Use'"
            />
            <span>Use</span>
            <input
              type="checkbox"
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            <strong> Program name: </strong>
            <span>{{ dataItem?.TEC_RFHREC_MNTFPROG }}</span>
          </div>
        </div>
      </div>
      <div class="grid grid-cols-2">
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_MNTFNOZ === 'Automatic'"
            />
            <span>Automatic</span>
            <input
              type="checkbox"
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_MNTFSUPT === 'Pin'"
            />
            <span>Pin</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_MNTFSUPT === 'Magnet'"
            />
            <span>Magnet</span>
            <input
              type="checkbox"
    ...
    <div class="border border-black px-3 py-4 avoid-break-inside">
      <div class="grid grid-cols-2">
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_MNTSN === 'Use'"
            />
            <span>Use</span>
            <input
              type="checkbox"
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            <strong> Program name: </strong>
            <span>{{ dataItem?.TEC_RFHREC_MNTSNPROG }}</span>
          </div>
        </div>
      </div>
      <div class="grid grid-cols-2">
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_MNTSNNOZ === 'Automatic'"
            />
            <span>Automatic</span>
            <input
              type="checkbox"
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_MNTSNSUPT === 'Pin'"
            />
            <span>Pin</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_MNTSNSUPT === 'Magnet'"
            />
            <span>Magnet</span>
            <input
              type="checkbox"
    ...
    <div class="border border-black px-3 py-4 avoid-break-inside">
      <div class="grid grid-cols-2">
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_MNTTR === 'Use'"
            />
            <span>Use</span>
            <input
              type="checkbox"
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            <strong> Program name: </strong>
            <span>{{ dataItem?.TEC_RFHREC_MNTTRPROG }}</span>
          </div>
        </div>
      </div>
      <div class="grid grid-cols-2">
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_MNTTRNOZ === 'Automatic'"
            />
            <span>Automatic</span>
            <input
              type="checkbox"
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_MNTTRSUPT === 'Pin'"
            />
            <span>Pin</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_MNTTRSUPT === 'Magnet'"
            />
            <span>Magnet</span>
            <input
              type="checkbox"
    ...
    <div class="border border-black px-3 py-4 avoid-break-inside">
      <div class="grid grid-cols-2">
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_MNTFO === 'Use'"
            />
            <span>Use</span>
            <input
              type="checkbox"
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            <strong> Program name: </strong>
            <span>{{ dataItem?.TEC_RFHREC_MNTFOPROG }}</span>
          </div>
        </div>
      </div>
      <div class="grid grid-cols-2">
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_MNTFONOZ === 'Automatic'"
            />
            <span>Automatic</span>
            <input
              type="checkbox"
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_MNTFOSUPT === 'Pin'"
            />
            <span>Pin</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_MNTFOSUPT === 'Magnet'"
            />
            <span>Magnet</span>
            <input
              type="checkbox"
    ...
    <div class="border border-black px-3 py-4 avoid-break-inside">
      <div class="grid grid-cols-2">
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_MNTINSP === 'Use'"
            />
            <span>Use</span>
            <input
              type="checkbox"
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            <strong> Program name: </strong>
            <span>{{ dataItem?.TEC_RFHREC_MNTINSPPROG }}</span>
          </div>
        </div>
      </div>
    </div>
    <div class="border border-black px-3 py-4 avoid-break-inside">
      <div class="grid grid-cols-2">
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_REFLOW === 'Use'"
            />
            <span>Use</span>
            <input
              type="checkbox"
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            <strong> Program name: </strong>
            <span>{{ dataItem?.TEC_RFHREC_REFLPROG }}</span>
          </div>
        </div>
      </div>
      <div class="grid grid-cols-2">
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <span>Use</span>
            <span>{{
              dataItem?.TEC_RFHREC_REFLOXYGEN === "Use"
                ? dataItem?.TEC_RFHREC_REFLOO
                : ""
            }}</span>
            <input
              type="checkbox"
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_REFLPCBSUPT === 'Use'"
            />
            <span>Use</span>
            ...
            <tbody>
              <tr>
                ...
                <td class="p-2 break-words">
                  {{ dataItem?.TEC_RFHREC_TOP_TEMPCH1 }}
                </td>
                <td class="p-2 break-words">
                  {{ dataItem?.TEC_RFHREC_BTM_TEMPCH1 }}
                </td>
              </tr>
              <tr>
                <td class="p-2 break-words">CH-2</td>
                <td class="p-2 break-words">
                  {{ dataItem?.TEC_RFHREC_TOP_TEMPCH2 }}
                </td>
                <td class="p-2 break-words">
                  {{ dataItem?.TEC_RFHREC_BTM_TEMPCH2 }}
                </td>
              </tr>
              <tr>
                <td class="p-2 break-words">CH-3</td>
                <td class="p-2 break-words">
                  {{ dataItem?.TEC_RFHREC_TOP_TEMPCH3 }}
                </td>
                <td class="p-2 break-words">
                  {{ dataItem?.TEC_RFHREC_BTM_TEMPCH3 }}
                </td>
              </tr>
              <tr>
                <td class="p-2 break-words">CH-4</td>
                <td class="p-2 break-words">
                  {{ dataItem?.TEC_RFHREC_TOP_TEMPCH4 }}
                </td>
                <td class="p-2 break-words">
                  {{ dataItem?.TEC_RFHREC_BTM_TEMPCH4 }}
                </td>
              </tr>
              <tr>
                <td class="p-2 break-words">CH-5</td>
                <td class="p-2 break-words">
                  {{ dataItem?.TEC_RFHREC_TOP_TEMPCH5 }}
                </td>
                <td class="p-2 break-words">
                  {{ dataItem?.TEC_RFHREC_BTM_TEMPCH5 }}
                </td>
              </tr>
              <tr>
                <td class="p-2 break-words">CH-6</td>
                <td class="p-2 break-words">
                  {{ dataItem?.TEC_RFHREC_TOP_TEMPCH6 }}
                </td>
                <td class="p-2 break-words">
                  {{ dataItem?.TEC_RFHREC_BTM_TEMPCH6 }}
                </td>
              </tr>
              <tr>
                <td class="p-2 break-words">CH-7</td>
                <td class="p-2 break-words">
                  {{ dataItem?.TEC_RFHREC_TOP_TEMPCH7 }}
                </td>
                <td class="p-2 break-words">
                  {{ dataItem?.TEC_RFHREC_BTM_TEMPCH7 }}
                </td>
              </tr>
              <tr>
                <td class="p-2 break-words">CH-8</td>
                <td class="p-2 break-words">
                  {{ dataItem?.TEC_RFHREC_TOP_TEMPCH8 }}
                </td>
                <td class="p-2 break-words">
                  {{ dataItem?.TEC_RFHREC_BTM_TEMPCH8 }}
                </td>
              </tr>
              <tr>
                <td class="p-2 break-words">CH-9</td>
                <td class="p-2 break-words">
                  {{ dataItem?.TEC_RFHREC_TOP_TEMPCH9 }}
                </td>
                <td class="p-2 break-words">
                  {{ dataItem?.TEC_RFHREC_BTM_TEMPCH9 }}
                </td>
              </tr>
              <tr>
                <td class="p-2 break-words">CH-10</td>
                <td class="p-2 break-words">
                  {{ dataItem?.TEC_RFHREC_TOP_TEMPCH10 }}
                </td>
                <td class="p-2 break-words">
                  {{ dataItem?.TEC_RFHREC_BTM_TEMPCH10 }}
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_PCBCOOL === 'Use'"
            />
            <span>Use</span>
            <input
              type="checkbox"
    ...
    <div class="border border-black px-3 py-4 avoid-break-inside">
      <div class="grid grid-cols-2">
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_AUTO === 'Use'"
            />
            <span>Use</span>
            <input
              type="checkbox"
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            <strong> Program name: </strong>
            <span>{{ dataItem?.TEC_RFHREC_AUTOPROG }}</span>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_NGSTCK === 'Use'"
            />
            <span>Use</span>
            <input
              type="checkbox"
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_NGSTCKPITCH === '10 mm.'"
            />
            <span>10 mm.</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_NGSTCKPITCH === '20 mm.'"
            />
            <span>20 mm.</span>
            <input
              type="checkbox"
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_TRACE === 'Use'"
            />
            <span>Use</span>
            <input
              type="checkbox"
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_UNLOADER === 'Use'"
            />
            <span>Use</span>
            <input
              type="checkbox"
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_UNLOADERPITCH === '10 mm.'"
            />
            <span>10 mm.</span>
            <input
              type="checkbox"
              class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_UNLOADERPITCH === '20 mm.'"
            />
            <span>20 mm.</span>
            <input
              type="checkbox"
