    ...
    <div class="pa-3 border border-black w-[800px] bg-white mt-3 space-y-2">
      ...
      <div class="grid grid-cols-2">
        ...
        <div class="flex flex-col">
          ...
          <span>{{ dataItem?.TEC_RFHREC_PCBCLNFUNC === 'etc' ? dataItem?.TEC_RFHREC_PCBLNETC_DTL : ''
            }}</span>
        </div>
      </div>
      <div class="grid grid-cols-2">
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input type="checkbox" class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_PRINTPROG === 'Referent Assembly chart part list for AM'" />
      ...
      <div class="grid grid-cols-2">
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <span>REF#</span>
            <span class="ms-2">{{ dataItem?.TEC_RFHREC_PRINTMM === 'REF' ? dataItem?.TEC_RFHREC_PRINTREF : '' }}</span>
          </div>
        </div>
      </div>
      <div class="grid grid-cols-2">
      ...
      <div class="grid grid-cols-2">
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input type="checkbox" class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_PRINTSOLDER === 'Referent Assembly chart part list for AM'" />
            <span>Referent Assembly chart part list for AM</span>
      ...
      <div class="grid grid-cols-2">
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            <strong> Program name: </strong>
            <input type="checkbox" class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_GLUEPROG === 'Referent Assembly chart part list for AM'" />
            <span>Referent Assembly chart part list for AM</span>
          </div>
        </div>
      </div>
      <div class="grid grid-cols-2">
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <input type="checkbox" class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_GLUENUM === 'Referent Assembly chart part list for AM'" />
            <span>Referent Assembly chart part list for AM</span>
          </div>
        </div>
      </div>
      <div class="grid grid-cols-2">
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            <strong> Program name: </strong>
            <input type="checkbox" class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_SOLDERPROG === 'Referent Assembly chart part list for AM'" />
            <span>Referent Assembly chart part list for AM</span>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-2">
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            <strong> Program name: </strong>
            <input type="checkbox" class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_MNTFPROG === 'Referent Assembly chart part list for AM'" />
            <span>Referent Assembly chart part list for AM</span>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-2">
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            <strong> Program name: </strong>
            <input type="checkbox" class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_MNTSNPROG === 'Referent Assembly chart part list for AM'" />
            <span>Referent Assembly chart part list for AM</span>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-2">
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            <strong> Program name: </strong>
            <input type="checkbox" class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_MNTTRPROG === 'Referent Assembly chart part list for AM'" />
            <span>Referent Assembly chart part list for AM</span>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-2">
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            <strong> Program name: </strong>
            <input type="checkbox" class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_MNTFOPROG === 'Referent Assembly chart part list for AM'" />
            <span>Referent Assembly chart part list for AM</span>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-2">
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            <strong> Program name: </strong>
            <input type="checkbox" class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_MNTINSPPROG === 'Referent Assembly chart part list for AM'" />
            <span>Referent Assembly chart part list for AM</span>
          </div>
        </div>
      </div>
      <div class="grid grid-cols-2">
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            <strong> Program name: </strong>
            <input type="checkbox" class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_REFLPROG === 'Referent Assembly chart part list for AM'" />
            <span>Referent Assembly chart part list for AM</span>
          </div>
        </div>
      </div>
      <div class="grid grid-cols-2">
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            ...
            <span>Use</span>
            <span>{{ dataItem?.TEC_RFHREC_REFLOXYGEN === 'Use' ? dataItem?.TEC_RFHREC_REFLOO : '' }}</span>
      ...
      <div class="grid grid-cols-2">
        ...
        <div class="flex flex-col">
          <div class="flex items-center gap-2">
            <strong> Program name: </strong>
            <input type="checkbox" class="w-4 h-4 mt-3"
              :checked="dataItem?.TEC_RFHREC_AUTOPROG === 'Referent Assembly chart part list for AM'" />
            <span>Referent Assembly chart part list for AM</span>
          </div>
        </div>
      </div>
