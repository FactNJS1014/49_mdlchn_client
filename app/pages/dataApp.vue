                                        ...
                                        <table class="border border-blue-800">
                                            <tbody>
                                                ...
                                                <tr class="border">
                                                    ...
                                                    <td class="px-2 text-sky-800">
                                                        {{ item.raw.OPR_HREC_LOTS_CHN }} pcs.
                                                    </td>
                                                </tr>
                                                <tr class="border">
                                                    <th class="text-left border pa-2 text-sky-800 w-30">
                                        ...
                                        <table class="border border-blue-800">
                                            <tbody>
                                                ...
                                                <tr class="border">
                                                    ...
                                                    <td class="px-2 text-sky-800">
                                                        {{ item.raw.OPR_HREC_PROCS_RF_CHN }}
                                                    </td>
                                                </tr>
                                                <tr class="border">
                                                    <th class="text-left border pa-2 text-sky-800 w-30">
        ...
        <v-card min-width="1300" class="overflow-hidden">
            ...
            <template #title>
                <div class="flex gap-3">
                    <h1 class="font-weight-bold text-blue-darken-3">
                        Details: {{ items?.OPR_HREC_ISSUENO }},
                    </h1>

                    <h1 class="font-weight-medium text-blue-darken-3">
                        EMPLOYEE ID: {{ items?.TEC_CPHREC_EMPNO }}
                    </h1>
                </div>
            </template>
                ...
                <v-virtual-scroll :items="[1]" height="550" item-height="auto" class="overflow-x-hidden">
                    <v-row>
                        <v-col cols="auto" md="6">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Loader
                                    Input</span>: {{ items?.TEC_CPHREC_LOADINP }}
                            </p>
                        </v-col>
                        <v-col cols="auto" md="6" v-if="items?.TEC_CPHREC_LOADINP === 'Use'">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Pitch
                                    Setting: </span>{{ items?.TEC_CPHREC_LOADINPPITCH }}
                            </p>
                        </v-col>
                    </v-row>
                    <v-row>
                    ...
                    <v-row>
                        <v-col cols="auto" md="6">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Traceability
                                    Input</span>: {{ items?.TEC_CPHREC_TRACEINP }}
                            </p>
                        </v-col>
                    </v-row>
                    <v-row>
                        <v-col cols="auto" md="6">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">PCB Cleaning
                                </span>: {{ items?.TEC_CPHREC_PCBCLEAN }}
                            </p>
                        </v-col>
                        <v-col cols="auto" md="6" v-if="items?.TEC_CPHREC_PCBCLEAN === 'Use'">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Traceability
                                    Input</span>: {{ items?.TEC_CPHREC_PCBCLNFUNC }}
                            </p>
                        </v-col>
                    </v-row>
                    <v-row>
                        <v-col cols="auto" md="6">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Glue (M/C
                                    #1) </span>: {{ items?.TEC_CPHREC_GLUE }}
                            </p>
                        </v-col>
                        <v-col cols="auto" md="6" v-if="items?.TEC_CPHREC_GLUE === 'Use'">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Program name
                                </span>: {{ items?.TEC_CPHREC_GLUEPROG }}
                            </p>
                        </v-col>
                    </v-row>
                    <v-row>
                        ...
                        <v-col cols="auto" md="6">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Glue number
                                </span>: {{ items?.TEC_CPHREC_GLUENUM }}
                            </p>
                        </v-col>
                    </v-row>
                    <v-row>
                        ...
                        <v-col cols="auto" md="6">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Head Unit
                                </span>: {{ items?.TEC_CPHREC_GLUEHUNIT }}
                            </p>
                        </v-col>
                    </v-row>
                    <v-row>
                        ...
                        <v-col cols="auto" md="6" v-if="items?.TEC_CPHREC_GLUESTDOK == 'OK'">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Backup pin
                                    standard no. </span>: {{ items?.TEC_CPHREC_GLUESTDOK }}
                            </p>
                        </v-col>
                        <v-col cols="auto" md="6" v-else>
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Backup pin
                                    standard no. </span>: {{ items?.TEC_CPHREC_GLUESTDNOT }}
                            </p>
                        </v-col>
                    </v-row>
                    <v-row>
                        <v-col cols="auto" md="6">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Glue (M/C
                                    #2) </span>: {{ items?.TEC_CPHREC_GLUESND }}
                            </p>
                        </v-col>
                        <v-col cols="auto" md="6" v-if="items?.TEC_CPHREC_GLUE === 'Use'">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Program name
                                </span>: {{ items?.TEC_CPHREC_GLUESNDPROG }}
                            </p>
                        </v-col>
                    </v-row>
                    <v-row v-if="items?.TEC_CPHREC_GLUE === 'Use'">
                        ...
                        <v-col cols="auto" md="6">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Glue number
                                </span>: {{ items?.TEC_CPHREC_GLUESNDNUM }}
                            </p>
                        </v-col>
                    </v-row>
                    <v-row v-if="items?.TEC_CPHREC_GLUE === 'Use'">
                        ...
                        <v-col cols="auto" md="6">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Head Unit
                                </span>: {{ items?.TEC_CPHREC_GLUESNDHUNIT }}
                            </p>
                        </v-col>
                    </v-row>
                    <v-row v-if="items?.TEC_CPHREC_GLUE === 'Use'">
                        ...
                        <v-col cols="auto" md="6" v-else>
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Backup pin
                                    standard no. </span>: {{ items?.TEC_CPHREC_GLUESNDNOT }}
                            </p>
                        </v-col>
                    </v-row>
                    <v-row>
                        <v-col cols="auto" md="6">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Mounter (M/C
                                    #1) </span>: {{ items?.TEC_CPHREC_MNTF }}
                            </p>
                        </v-col>
                        <v-col cols="auto" md="6" v-if="items?.TEC_CPHREC_MNTF === 'Use'">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Program name
                                </span>: {{ items?.TEC_CPHREC_MNTFPROG }}
                            </p>
                        </v-col>
                    </v-row>
                    <v-row v-if="items?.TEC_CPHREC_MNTF === 'Use'">
                        ...
                        <v-col cols="auto" md="6">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Nozzle
                                    setting </span>: {{ items?.TEC_CPHREC_MNTFNOZ }}
                            </p>
                        </v-col>
                    </v-row>
                    <v-row v-if="items?.TEC_CPHREC_MNTF === 'Use'">
                        ...
                        <v-col cols="auto" md="6">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Support PCB
                                </span>: {{ items?.TEC_CPHREC_MNTFSUPT }}
                            </p>
                        </v-col>
                    </v-row>
                    <v-row>
                    ...
                    <v-row v-if="items?.TEC_CPHREC_MNTSN === 'Use'">
                        ...
                        <v-col cols="auto" md="6">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Nozzle
                                    setting </span>: {{ items?.TEC_CPHREC_MNTSNNOZ }}
                            </p>
                        </v-col>
                    </v-row>
                    <v-row v-if="items?.TEC_CPHREC_MNTSN === 'Use'">
                        ...
                        <v-col cols="auto" md="6">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Nozzle
                                    setting </span>: {{ items?.TEC_CPHREC_MNTSNSUPT }}
                            </p>
                        </v-col>
                    </v-row>
                    ...
                    <v-row>
                        <v-col cols="auto" md="6">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Mounter (M/C
                                    #3) </span>: {{ items?.TEC_CPHREC_MNTTR }}
                            </p>
                        </v-col>
                        <v-col cols="auto" md="6" v-if="items?.TEC_CPHREC_MNTTR === 'Use'">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Program name
                                </span>: {{ items?.TEC_CPHREC_MNTTRPROG }}
                            </p>
                        </v-col>
                    </v-row>
                    <v-row v-if="items?.TEC_CPHREC_MNTTR === 'Use'">
                        ...
                        <v-col cols="auto" md="6">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Nozzle
                                    setting </span>: {{ items?.TEC_CPHREC_MNTTRNOZ }}
                            </p>
                        </v-col>
                    </v-row>
                    <v-row v-if="items?.TEC_CPHREC_MNTTR === 'Use'">
                        ...
                        <v-col cols="auto" md="6">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Nozzle
                                    setting </span>: {{ items?.TEC_CPHREC_MNTTRSUPT }}
                            </p>
                        </v-col>
                    </v-row>
                    <v-row>
                        <v-col cols="auto" md="6">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Mounter (M/C
                                    #4) </span>: {{ items?.TEC_CPHREC_MNTFO }}
                            </p>
                        </v-col>
                        <v-col cols="auto" md="6" v-if="items?.TEC_CPHREC_MNTFO === 'Use'">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Program name
                                </span>: {{ items?.TEC_CPHREC_MNTFOPROG }}
                            </p>
                        </v-col>
                    </v-row>
                    <v-row v-if="items?.TEC_CPHREC_MNTFO === 'Use'">
                        <v-col cols="auto" md="6"></v-col>
                        <v-col cols="auto" md="6">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Nozzle
                                    setting </span>: {{ items?.TEC_CPHREC_MNTFONOZ }}
                            </p>
                        </v-col>
                    </v-row>
                    <v-row v-if="items?.TEC_CPHREC_MNTFO === 'Use'">
                        ...
                        <v-col cols="auto" md="6">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Nozzle
                                    setting </span>: {{ items?.TEC_CPHREC_MNTFOSUPT }}
                            </p>
                        </v-col>
                    </v-row>
                    <v-row>
                        <v-col cols="auto" md="6">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Mount
                                    inspector</span>: {{ items?.TEC_CPHREC_MNTINSP }}
                            </p>
                        </v-col>
                        <v-col cols="auto" md="6" v-if="items?.TEC_CPHREC_MNTINSP === 'Use'">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Program name
                                </span>: {{ items?.TEC_CPHREC_MNTINSPPROG }}
                            </p>
                        </v-col>
                    </v-row>
                    <v-row>
                        <v-col cols="auto" md="6">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span
                                    class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Reflow</span>:
                                {{ items?.TEC_CPHREC_REFLOW }}
                            </p>
                        </v-col>
                        <v-col cols="auto" md="6" v-if="items?.TEC_CPHREC_REFLOW === 'Use'">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Program name
                                </span>: {{ items?.TEC_CPHREC_REFLPROG }}
                            </p>
                        </v-col>
                    </v-row>
                    <v-row v-if="items?.TEC_CPHREC_REFLOW === 'Use'">
                        <v-col cols="auto" md="6"></v-col>
                        <v-col cols="auto" md="6">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Oxygen
                                </span>:{{ items?.TEC_CPHREC_REFLOXYGEN }}
                            </p>
                        </v-col>
                        <v-col cols="auto" md="6" v-if="items?.TEC_CPHREC_REFLOXYGEN === 'Use'">
                            <p class="border pa-2 rounded-tl-md rounded-bl-md">
                                <span class="bg-blue-200 pa-2 rounded-tl-md rounded-bl-md font-weight-bold">Oxygen
                                </span>:{{ items?.TEC_CPHREC_REFLUSEOO }}
                            </p>
                        </v-col>
                    </v-row>
                </v-virtual-scroll>
