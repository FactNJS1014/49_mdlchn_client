                            ...
                            <v-form @submit.prevent="handleSubmitForm">
                                ...
                                <v-row no-gutters class="gap-3">
                                    <v-col cols="4">
                                        ...
                                        <v-select v-model="line" variant="outlined" rounded="md" :items="line_list"
                                            item-title="LINE_NAME" :rules="LineRules">
                                        </v-select>
                                    </v-col>
                                    <v-col cols="4">
                                        <div class="mt-3 font-semibold">Issue No. :</div>
                                        <v-text-field variant="outlined" rounded="md" v-model="issue_no"
                                            :rules="IssueNoRules">
                                        </v-text-field>
                                    </v-col>
                                    <v-col cols="3" md="3">
                                ...
                                <v-row no-gutters class="gap-3">
                                    <v-col cols="4" md="5">
                                        ...
                                        <v-autocomplete variant="outlined" rounded="md" :items="won_list"
                                            item-title="WON" item-value="WON" v-model="won_cur" :rules="WorkOrderRules"
                                            @update:modelValue="SelectWonCur"></v-autocomplete>
                                    </v-col>
                                    <v-col cols="6" md="5">
                                        <div class="mt-3 font-semibold">Current Model Code :</div>
                                        <v-text-field variant="outlined" rounded="md" v-model="cur_modelname"
                                    ...
                                    <v-col cols="6" md="5">
                                        ...
                                        <v-number-input variant="outlined" rounded="md" v-model="lots" :min="0"
                                            :rules="LotsRules" />
                                    </v-col>
                                ...
                                <v-row no-gutters class="gap-3">
                                    <v-col cols="4" md="5">
                                        ...
                                        <v-autocomplete variant="outlined" rounded="md" :items="won_list"
                                            item-title="WON" item-value="WON" v-model="won_chn" :rules="WorkOrderRules"
                                            @update:modelValue="SelectWonChn"></v-autocomplete>
                                    </v-col>
                                    <v-col cols="6" md="5">
                                        <div class="mt-3 font-semibold">Change Model Code :</div>
                                        <v-text-field variant="outlined" rounded="md" v-model="chn_modelname"
                                    ...
                                    <v-col cols="6" md="5">
                                        ...
                                        <v-number-input variant="outlined" rounded="md" v-model="lots_chn" :min="0"
                                            :rules="LotsRules" />
                                    </v-col>
                                    <v-col cols="6" md="3" v-if="prs_check">
                                        <div class="mt-3 font-semibold">Process: (RF) เปลี่ยน</div>
                                        <v-radio-group inline class="gap-4" v-model="procs_rf_chn"
                                            :rules="ProcessRules">
                                            <v-radio label="CP" value="CP" color="info"></v-radio>
                                            <v-radio label="RF1" value="RF1" color="info"></v-radio>
                                            <v-radio label="RF2" value="RF2" color="info"></v-radio>
                                ...
                                <v-row no-gutters class="gap-3">
                                    <v-col cols="6" md="5">
                                        ...
                                        <v-text-field variant="outlined" density="compact" v-model="prog_name"
                                            :rules="programNameRules" />
                                    </v-col>
                                    <v-col cols="6" md="5">
                                        <div class="mt-3 font-semibold">REV :</div>
                                        <v-text-field variant="outlined" density="compact" v-model="prog_rev"
                                            :rules="revInputRules" />
                                    </v-col>
                                </v-row>
